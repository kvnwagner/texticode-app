...
class ComprobantePdfService {
  ...
  static Future<Uint8List> generar({
    ...
    final entregado = comprobante.estado.toLowerCase().contains('entregado') ||
    ...
    const cantidad = 1; // ⚠️ tu backend actual no expone la cantidad real de la orden.
    const observaciones = 'Ninguna observación registrada para este pedido.';
                      ...
                      pw.Row(
                        children: [
                          pw.Container(
                            ...
                            child: pw.Center(child: pw.Image(logo, width: 30, height: 30)),
                          ),
                          ...
                          children: [
                            ...
                            pw.Container(
                              ...
                              decoration: pw.BoxDecoration(
                                  color: estadoBg, borderRadius: pw.BorderRadius.circular(2)),
                              child: pw.Text(estadoLabel,
                                  style: pw.TextStyle(
                                      fontSize: 9, fontWeight: pw.FontWeight.bold, color: estadoTexto)),
                            ),
                            pw.SizedBox(height: 12),
                ...
                pw.Table(
                  ...
                  children: [
                    pw.TableRow(
                      ...
                      children: [
                        _thCell('#', align: pw.TextAlign.left),
                        _thCell('DESCRIPCIÓN DEL PRODUCTO / SERVICIO', align: pw.TextAlign.left),
                        _thCell('CANTIDAD', align: pw.TextAlign.center),
                        _thCell('ESTADO ENTREGA', align: pw.TextAlign.right),
                      ],
                    ),
                    pw.TableRow(
                        ...
                        pw.Padding(
                          ...
                          child: pw.Align(
                            ...
                            child: pw.Container(
                              ...
                              child: pw.Text(estadoLabel,
                                  style: pw.TextStyle(
                                      fontSize: 8, fontWeight: pw.FontWeight.bold, color: estadoTexto)),
                            ),
                          ),
                        ),
                      ],
  ...
  static pw.Widget _thCell(String text, {pw.TextAlign align = pw.TextAlign.left}) {
    return pw.Padding(
      padding: const pw.EdgeInsets.symmetric(horizontal: 12, vertical: 8),
      child: pw.Text(text,
          textAlign: align,
  ...
  static pw.Widget _tdCell(String text,
      {pw.TextAlign align = pw.TextAlign.left, PdfColor color = _negro}) {
    return pw.Padding(
      padding: const pw.EdgeInsets.symmetric(horizontal: 12, vertical: 10),
      child: pw.Text(text, textAlign: align, style: pw.TextStyle(fontSize: 9, color: color)),
    );
  }
