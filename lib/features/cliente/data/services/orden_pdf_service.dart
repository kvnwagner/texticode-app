...
class OrdenPdfService {
  ...
  static Future<Uint8List> generar({required Orden orden}) async {
    final doc = pw.Document();

    pw.MemoryImage? logo;
    try {
      final logoBytes = await rootBundle.load('assets/images/logo_texticode.png');
            ...
            child: pw.Column(
              ...
              children: [
                  ...
                  child: pw.Row(
                    ...
                    children: [
                          ...
                          pw.Column(
                            ...
                            children: [
                              ...
                              pw.Text('Bogotá, Colombia  ·  texticode@correo.com  ·  +57 300 000 0000',
                                  style: const pw.TextStyle(color: _azulClaro, fontSize: 8)),
                            ],
                          ),
                        ],
                      ),
                      pw.Column(
                        ...
                        children: [
                          pw.Text('FICHA DE PEDIDO',
                              style: const pw.TextStyle(
                                  color: _azulClaro, fontSize: 9, letterSpacing: 1.5)),
                          pw.SizedBox(height: 3),
                          pw.Text(orden.codigoOrden.isEmpty ? '#$numero' : orden.codigoOrden,
                              style: const pw.TextStyle(
                                  color: PdfColors.white,
                                  fontSize: 20,
                                  fontWeight: pw.FontWeight.bold)),
                ...
                pw.Container(
                  padding: const pw.EdgeInsets.symmetric(horizontal: 32, vertical: 18),
                  decoration: const pw.BoxDecoration(
                    border: pw.Border(bottom: pw.BorderSide(color: _grisLinea)),
                  ),
                  child: pw.Row(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Expanded(
                        ...
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.Text(orden.producto,
                                style: const pw.TextStyle(
                                    fontSize: 13, fontWeight: pw.FontWeight.bold, color: _negro)),
                            if ((orden.descripcion ?? '').trim().isNotEmpty) ...[
                              pw.SizedBox(height: 4),
                              pw.Text(orden.descripcion!,
                      ...
                      pw.Expanded(
                        child: pw.Column(
                          ...
                          children: [
                            ...
                            pw.SizedBox(height: 4),
                            pw.Text(_fechaSimple(orden.fechaCreacion),
                                style: const pw.TextStyle(fontSize: 10, color: _negro)),
                            pw.SizedBox(height: 12),
                            _label('FECHA LÍMITE'),
                            pw.SizedBox(height: 4),
                            pw.Text(orden.fechaCorta.isEmpty ? 'Sin fecha' : orden.fechaCorta,
                                style: const pw.TextStyle(fontSize: 10, color: _negro)),
                          ],
                        ),
                      ),
                          ...
                          children: [
                            ...
                            pw.Container(
                              ...
                              decoration: pw.BoxDecoration(
                                  color: estadoBg, borderRadius: pw.BorderRadius.circular(10)),
                              child: pw.Text(orden.estadoLabel,
                                  style: pw.TextStyle(
                                      fontSize: 9,
                                      fontWeight: pw.FontWeight.bold,
                                      color: estadoTexto)),
                            ...
                            pw.Container(
                              padding: const pw.EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                              decoration: pw.BoxDecoration(
                                  color: prioBg, borderRadius: pw.BorderRadius.circular(10)),
                              child: pw.Text(orden.prioridadLabel,
                                  style: pw.TextStyle(
                                      fontSize: 9,
                                      fontWeight: pw.FontWeight.bold,
                                      color: prioTexto)),
                ...
                pw.Container(
                  padding: const pw.EdgeInsets.fromLTRB(32, 18, 32, 12),
                  child: pw.Column(
                    crossAxisAlignment: pw.CrossAxisAlignment.start,
                    children: [
                      pw.Row(
                        mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                        children: [
                          pw.Text('PROGRESO DE FABRICACIÓN',
                              style: pw.TextStyle(
                                  fontSize: 9,
                                  fontWeight: pw.FontWeight.bold,
                                  color: _grisTexto,
                                  letterSpacing: 1)),
                          pw.Text('${orden.progresoPorcentaje}%',
                              style: pw.TextStyle(
                                  fontSize: 11, fontWeight: pw.FontWeight.bold, color: _azul)),
                        ],
                      ),
                      ...
                      pw.ClipRRect(
                        ...
                        child: pw.Row(
                          children: [
                            pw.Expanded(
                              flex: _progresoFlex(orden.progreso),
                              child: pw.Container(height: 8, color: _azul),
                            ),
                            pw.Expanded(
                              flex: 100 - _progresoFlex(orden.progreso),
                              child: pw.Container(height: 8, color: _grisLinea),
                            ),
                          ],
                        ),
                      ),
                ...
                // ── Tabla de materiales ──
                pw.Container(
                  margin: const pw.EdgeInsets.fromLTRB(32, 6, 32, 0),
                  decoration: pw.BoxDecoration(
                ...
                pw.Container(
                  ...
                  child: pw.Row(
                    mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                    children: [
                      pw.Text('Documento informativo · TEXTICODE S.A.S.',
                          style: const pw.TextStyle(color: _azulClaro, fontSize: 8)),
  ...
  static (PdfColor, PdfColor) _estadoColores(Orden o) {
    if (o.isCompletada) return (_verdeBg, _verdeTexto);
    if (o.isEnProceso) return (_moradoBg, _moradoTexto);
    if (o.isRetrasada) return (_rojoBg, _rojoTexto);
    return (_amarilloBg, _amarilloTexto);
  }

  static (PdfColor, PdfColor) _prioridadColores(Orden o) {
    if (o.isAlta) return (_rojoBg, _rojoTexto);
    if (o.isBaja) return (_verdeBg, _verdeTexto);
    return (_amarilloBg, _amarilloTexto);
  }
  ...
  /// para dibujar la barra con dos Expanded (Expanded no acepta flex 0).
