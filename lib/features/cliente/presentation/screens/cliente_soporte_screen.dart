...
class _ClienteSoporteScreenState extends State<ClienteSoporteScreen> {
  ...
  Future<void> _launchOrSnack(Uri uri, String errorMsg) async {
  ...
  Future<void> _callSupport(String phone) async {
    ...
    await _launchOrSnack(Uri(scheme: 'tel', path: clean), 'No se pudo iniciar la llamada.');
  }
  ...
  Future<void> _sendEmail(String email) async {
    await _launchOrSnack(
      Uri(scheme: 'mailto', path: email, query: 'subject=Soporte Texticode'),
